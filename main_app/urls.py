...
urlpatterns = [
    ...
    path('animals/<int:animal_id>/add_photo/',
         views.add_photo, name='add_photo'),
    path('animals/<int:pk>/remove_photo/',
         views.RemovePhoto.as_view(), name='remove_photo'),

    path('animals/<int:animal_id>/add_funfact/',
         views.add_funfact, name="add_funfact"),
    path('animals/<int:animal_id>/funfacts/<int:funfact_id>/like/',
         views.like, name='like'),

    path('funfacts/<int:pk>/delete/',
         views.FunFactDelete.as_view(), name='funfact_delete'),
